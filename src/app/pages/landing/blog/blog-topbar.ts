...
/** Standalone topbar for the public blog, same pattern as the BRVM tools'
 *  tool-topbars (logo → home, theme toggle, back link) so every "resource"
 *  page shares one navbar style. */
@Component({
    selector: 'app-blog-topbar',
    standalone: true,
