 ...
 *
 * GENERATED by resources/build_blog.py from resources/newsletters-2, do not
 * edit the BLOG_POSTS entries by hand (edit the source blocks JSON and rerun).
 ...
 * The edition number and send date come from each source's own subtitle and
 * publish_date, so a kanban re-order never has to rename files.
 */
...
export const BLOG_POSTS: BlogPost[] = [
    {
        ...
        date: '2026-06-01',
        tags: ['FIRE', 'indépendance financière', 'règle des 4 %', 'Lean FIRE', 'Barista FIRE', 'diaspora'],
        excerpt: 'Les origines : un livre et une idée radicale. Tout commence en 1992 avec Your Money or Your Life de Vicki Robin et Joe Dominguez. Leur thèse est simple mais…',
        readingMinutes: 6,
        coverImage: COVERS[0],
    ...
    },
    {
        ...
        date: '2026-06-15',
        tags: ['tontine', 'BRVM', 'épargne', 'diaspora', 'mobile money', 'discipline'],
    ...
    },
    {
        ...
        date: '2026-07-01',
        tags: ['PEA', 'ETF', 'diaspora', 'France', 'MSCI World', 'fiscalité'],
    ...
    },
    {
        ...
        date: '2026-07-15',
        tags: ['retraite', 'dividendes', 'BRVM', 'IPRES', 'diaspora', 'long terme'],
    ...
    },
    {
        ...
        date: '2026-08-01',
        tags: ['compte-titres', 'SGI', 'BRVM', 'checklist', 'ouverture de compte', 'FGI'],
    ...
    },
    {
        ...
        date: '2026-08-15',
        tags: ['SGI', 'courtier', 'frais', 'BRVM', 'comparateur', 'AMF-UMOA'],
    ...
    },
    {
        ...
        date: '2026-09-01',
        tags: ['DCA', 'BRVM', 'investissement programmé', '10 000 FCFA', 'discipline', 'débutant'],
        excerpt: 'Le DCA (Dollar Cost Averaging), ou investissement programmé, c\'est la méthode la plus simple qui existe : tu investis le même montant, à date fixe, sans…',
        readingMinutes: 7,
        coverImage: COVERS[6],
    ...
    },
    {
        ...
        date: '2026-09-15',
        tags: ['trading', 'DCA', 'frais BRVM', 'investissement', 'long terme', 'discipline', 'BRVM'],
        excerpt: 'Chaque semaine, tu vois passer des captures d\'écran de gains spectaculaires : +40 % en une journée sur une action, des groupes Telegram ou WhatsApp qui…',
        readingMinutes: 9,
        coverImage: COVERS[7],
    ...
    },
    {
        ...
        date: '2026-10-01',
        tags: ['immobilier', 'Dakar', 'Sénégal', 'diaspora', 'titre foncier', 'FIRE'],
    ...
    },
    {
        ...
        date: '2026-10-15',
        tags: ['règle des 4 %', 'FIRE', 'retraite', 'FCFA', 'BRVM', '×171'],
        excerpt: 'En 1994, William Bengen publie son étude sur les retraités américains : si tu retires 4 % de ton portefeuille la première année, puis le même montant ajusté…',
        readingMinutes: 5,
        coverImage: COVERS[9],
    ...
    },
    {
        ...
        date: '2026-11-01',
        tags: ['FCP', 'frais', 'DICI', 'OPCVM', 'BRVM', 'TER'],
        excerpt: 'Les FCP (Fonds Communs de Placement) sont souvent présentés comme la porte d\'entrée idéale à la BRVM. Tu confies ton argent à une société de gestion agréée…',
        readingMinutes: 6,
    ...
    },
    {
        ...
        date: '2026-11-15',
        tags: ['FCP', 'actions en direct', 'frais', 'DCA', 'BRVM', 'long terme'],
        excerpt: 'Dans l\'édition précédente, on a ouvert le DICI d\'un FCP : 2,58 % par an déjà retirés de la valeur des parts. La question logique qui suit : ne vaut-il pas…',
        readingMinutes: 6,
    ...
    },
    {
        ...
        date: '2026-12-01',
        tags: ['gestion sous mandat', 'gestion libre', 'SPIVA', 'SGI', 'frais', 'BRVM'],
        excerpt: 'L\'étude qui a tué le mythe du gérant star. Depuis 2002, S&P Dow Jones Indices publie chaque semestre un rapport appelé SPIVA (S&P Indices Versus Active).…',
        readingMinutes: 6,
    ...
    },
    {
        ...
        date: '2026-12-15',
        tags: ['indices', 'BRVM 30', 'BRVM Composite', 'BRVM Prestige', 'benchmark', 'BRVM'],
    ...
    },
    {
        ...
        date: '2027-01-01',
        tags: ['BRVM', 'S&P 500', 'rendement', 'dividendes', 'risque de change', 'diaspora'],
        excerpt: 'Dans le mouvement FIRE, le S&P 500 est la référence absolue. Environ 10 % de rendement annualisé sur 30 ans, des frais d\'ETF à 0,03 %, une liquidité totale.…',
        readingMinutes: 4,
    ...
    },
    {
        ...
        date: '2027-01-15',
        tags: ['BRVM', 'CAC 40', 'Stoxx 600', 'PEA', 'corrélation', 'diaspora'],
        excerpt: 'Tout le monde compare la BRVM au S&P 500. Mais c\'est le mauvais benchmark. Le FCFA est arrimé à l\'euro à un taux fixe (655,957 FCFA = 1 €) depuis 1999. Ton…',
        readingMinutes: 4,
    ...
    },
    {
        ...
        date: '2027-02-01',
        tags: ['risque', 'sécurité', 'diversification', 'BRVM', 'immobilier', 'S&P 500'],
        excerpt: 'Une vidéo circule avec un titre qui fait réagir : « La BRVM plus sécurisée que l\'immo et Wall Street ». Le propos mérite qu\'on s\'y arrête, pas pour le…',
        readingMinutes: 6,
 ...
 * its send `date` is today or earlier. Future editions stay hidden until their
 * date arrives, so the blog never leaks unsent content.
 */
