/**
 * Static metadata for the 17 FIRE Africa newsletter editions.
 *
...
export const BLOG_POSTS: BlogPost[] = [
    ...
    },
    {
        ...
        date: '2026-07-01',
        tags: ['tontine', 'BRVM', 'épargne', 'diaspora'],
    ...
    },
    {
        ...
        date: '2026-08-01',
        tags: ['PEA', 'ETF', 'diaspora', 'France'],
        excerpt: "Le PEA te permet d'investir dans l'économie mondiale avec une fiscalité quasi nulle après 5 ans. Et la diaspora ne l'utilise presque pas.",
        coverImage: cover(5),
        contentPath: 'assets/newsletters/edition-016-blocks.json',
    },
    {
        edition: '003',
