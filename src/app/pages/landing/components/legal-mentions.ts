            ...
            <main class="pt-32 pb-24 px-6 md:px-12 lg:px-20 max-w-3xl mx-auto">
                ...
                <article class="prose-omaad space-y-8">
                    <section>
                        ...
                        <p class="text-surface-700 leading-relaxed whitespace-pre-line">{{ blocks().publisher }}</p>
                    </section>
                    ...
                    <section>
                        ...
                        <p class="text-surface-700 leading-relaxed">{{ blocks().director }}</p>
                    </section>
                    ...
                    <section>
                        ...
                        <p class="text-surface-700 leading-relaxed whitespace-pre-line">{{ blocks().hosting }}</p>
                    </section>
                    ...
                    <section>
                        ...
                        <p class="text-surface-700 leading-relaxed">{{ blocks().ip }}</p>
                    </section>
