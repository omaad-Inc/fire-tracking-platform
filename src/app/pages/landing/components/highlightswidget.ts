            ...
            <div class="max-w-7xl mx-auto">
                <div class="text-center mb-16">
                    <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/10 dark:bg-cyan-500/20 border border-cyan-500/30 mb-6">
                        ...
                        <span class="text-cyan-600 dark:text-cyan-400 text-sm font-medium">{{ t('landing.highlights.badge') }}</span>
                    </div>
                    <h2 class="text-4xl md:text-5xl font-bold text-surface-900 dark:text-surface-0 mb-4">
                        {{ t('landing.highlights.h2a') }}
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-emerald-500">{{ t('landing.highlights.h2b') }}</span>
                    </h2>
                            ...
                            <div class="relative bg-slate-900 rounded-2xl p-6 shadow-2xl border border-slate-700/50">
                                <div class="mb-6">
                                    <div class="flex items-center justify-between mb-3">
                                        <span class="text-slate-300 font-medium">{{ t('landing.highlights.h1MockupTitle') }}</span>
                                        <span class="text-emerald-400 font-bold">43%</span>
                                    </div>
                                    <div class="h-4 bg-slate-800 rounded-full overflow-hidden">
                                        <div class="h-full bg-gradient-to-r from-indigo-600 via-cyan-500 to-emerald-500 rounded-full" style="width: 43%"></div>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div class="bg-slate-800/50 rounded-xl p-4">
                                        <div class="flex items-center gap-2 mb-2">
                                            ...
                                            <span class="text-slate-400 text-sm">{{ t('landing.highlights.h1MockupTime') }}</span>
                                        </div>
                                    ...
                                    <div class="bg-slate-800/50 rounded-xl p-4">
                                        <div class="flex items-center gap-2 mb-2">
                                            ...
                                            <span class="text-slate-400 text-sm">{{ t('landing.highlights.h1MockupRate') }}</span>
                                        </div>
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <div class="flex items-center justify-between mb-2">
                                            <div class="flex items-center gap-2"><div class="w-3 h-3 rounded-full bg-indigo-500"></div><span class="text-slate-300 text-sm">Immobilier</span></div>
                                            <span class="text-slate-400 text-sm">92%</span>
                                        </div>
                                        <div class="h-2 bg-slate-800 rounded-full"><div class="h-full bg-indigo-500 rounded-full" style="width: 92%"></div></div>
                                    </div>
                                    <div>
                                        <div class="flex items-center justify-between mb-2">
                                            <div class="flex items-center gap-2"><div class="w-3 h-3 rounded-full bg-cyan-500"></div><span class="text-slate-300 text-sm">Actions (PEA)</span></div>
                                            <span class="text-slate-400 text-sm">5%</span>
                                        </div>
                                        <div class="h-2 bg-slate-800 rounded-full"><div class="h-full bg-cyan-500 rounded-full" style="width: 5%"></div></div>
                                    </div>
                                    <div>
                                        <div class="flex items-center justify-between mb-2">
                                            <div class="flex items-center gap-2"><div class="w-3 h-3 rounded-full bg-emerald-500"></div><span class="text-slate-300 text-sm">Liquidités</span></div>
                                            <span class="text-slate-400 text-sm">2.3%</span>
                                        </div>
                                        <div class="h-2 bg-slate-800 rounded-full"><div class="h-full bg-emerald-500 rounded-full" style="width: 2.3%"></div></div>
                                    </div>
                                    <div>
                                        <div class="flex items-center justify-between mb-2">
                                            <div class="flex items-center gap-2"><div class="w-3 h-3 rounded-full bg-amber-500"></div><span class="text-slate-300 text-sm">Crypto</span></div>
                                            <span class="text-slate-400 text-sm">0.7%</span>
                                        </div>
                                        <div class="h-2 bg-slate-800 rounded-full"><div class="h-full bg-amber-500 rounded-full" style="width: 0.7%"></div></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export class HighlightsWidget {
    ...
    securityItems() {
        return [
            { title: this.t('landing.highlights.h3S1Title'), desc: this.t('landing.highlights.h3S1Desc'), icon: 'pi pi-lock text-emerald-400',  bg: 'bg-emerald-500/20' },
            { title: this.t('landing.highlights.h3S2Title'), desc: this.t('landing.highlights.h3S2Desc'), icon: 'pi pi-user-minus text-cyan-400',  bg: 'bg-cyan-500/20'    },
            { title: this.t('landing.highlights.h3S3Title'), desc: this.t('landing.highlights.h3S3Desc'), icon: 'pi pi-shield text-indigo-400',   bg: 'bg-indigo-500/20'  },
            { title: this.t('landing.highlights.h3S4Title'), desc: this.t('landing.highlights.h3S4Desc'), icon: 'pi pi-ban text-amber-400',       bg: 'bg-amber-500/20'   },
        ];
    }
}
