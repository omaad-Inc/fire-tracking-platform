            ...
            <div class="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24 py-12 bg-surface-0 dark:bg-surface-950">
                ...
                <div class="max-w-md">
                    ...
                    <p class="text-surface-600 dark:text-surface-400 mb-8">
                        Déjà un compte ?
                        <a [routerLink]="[currentLang, 'auth', 'login']" class="text-brand-700 dark:text-brand-300 dark:text-brand-700 dark:text-brand-300 hover:text-brand-700 dark:text-brand-300 dark:hover:text-brand-300 font-medium cursor-pointer">
                    ...
                    <form (ngSubmit)="onSubmit()" class="space-y-6">
                        ...
                        <button pButton pRipple label="Créer mon compte"
                                ...
                                [ngClass]="{
                                    '!bg-gradient-to-r !from-brand-700 !to-brand-500 !text-white hover:!shadow-lg hover:!shadow-card': isFormValid && !isLoading(),
