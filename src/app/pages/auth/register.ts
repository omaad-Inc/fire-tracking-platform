            ...
            <div class="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24 py-12 bg-surface-0 dark:bg-surface-950">
                ...
                <div class="max-w-md">
                    ...
                    <div class="space-y-3 mb-6">
                        <!-- Branded visible button + invisible Google rendered button overlay (see AuthService.initGoogleSignInButton). -->
            ...
            .subscribe({
                ...
                error: (err) => {
                    ...
                    this.messageService.add({
                        ...
                        detail: err?.message || 'Could not sign up with Google',
                        life: 5000,
                    });
                },
            });
