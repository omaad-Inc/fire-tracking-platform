                ...
                <div class="mb-12">
                    <a [routerLink]="[currentLang, 'landing']" class="flex items-center gap-3 cursor-pointer group">
                        <img src="assets/brand/omaad-icon.svg" alt="Omaad Logo"
                             class="w-10 h-10" width="40" height="40">
...
export class Login {
    ...
    setMode(mode: 'email' | 'phone') {
        // Phone sign-in is not live yet (flagged "coming soon"): force email so
        // no one can register/login by phone until the OTP flow works.
