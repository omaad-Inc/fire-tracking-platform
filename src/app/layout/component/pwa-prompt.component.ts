    ...
    template: `
        ...
        @if (showUpdateBanner && pwaService.hasUpdate()) {
            <div class="fixed top-0 left-0 right-0 z-[60] h-12 flex items-center justify-between px-4
                        bg-gradient-to-r from-brand-700 to-brand-500 shadow-md animate-slide-down">
            ...
            <div class="fixed z-[60] animate-slide-up
                ...
                <div class="sm:hidden rounded-2xl bg-surface-0 dark:bg-surface-900
                    ...
                    <div class="flex items-start gap-3">
                        <div class="w-11 h-11 rounded-xl bg-gradient-to-br from-brand-700 to-brand-500 flex items-center justify-center shrink-0 shadow-lg shadow-card">
                    ...
                    <div class="flex gap-2 mt-3">
                        <button pButton label="Installer" icon="pi pi-download"
                                (click)="installApp()"
                                class="flex-1 !bg-gradient-to-r !from-brand-700 !to-brand-500 !border-0 !text-white !py-2.5 !text-sm !font-semibold !rounded-xl"></button>
                ...
                <div class="hidden sm:flex items-center justify-between h-12 px-4
                    ...
                    <div class="flex items-center gap-2.5">
                        <div class="w-7 h-7 rounded-lg bg-gradient-to-br from-brand-700 to-brand-500 flex items-center justify-center">
                    ...
                    <div class="flex items-center gap-2">
                        <button pButton label="Installer" size="small"
                                (click)="installApp()"
                                class="!bg-gradient-to-r !from-brand-700 !to-brand-500 !text-white !border-0 !py-1 !px-3 !text-xs !font-semibold !rounded-lg"></button>
